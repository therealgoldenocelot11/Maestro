...
import { createHACDShapes, createHullShape, createTriMeshShape, createVHACDShapes, iterateGeometries } from './three-to-ammo.js';
...
class AmmoPhysics extends Events {
    ...
    constraints;
    collisionEvents;
    complexShapes = ['plane', 'hull', 'hacd', 'vhacd', 'convexMesh', 'concaveMesh'];
